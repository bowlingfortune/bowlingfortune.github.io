(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=t(r);fetch(r.href,n)}})();const Ve=new Set([" ","	",",",";"]),pe=new Set("0123456789-".split("")),Ke=new Set("0123456789-X/".split(""));function we(e){return Ve.has(e)}function D(e){const{line:o}=e;for(;e.index<o.length&&we(o[e.index]);)e.index+=1;if(e.index>=o.length)return null;const t=e.index+1,a=o[e.index].toUpperCase();return e.index+=1,{char:a,column:t}}function B(e){if(e==="X")return 10;if(e==="-")return 0;const o=Number.parseInt(e,10);if(Number.isNaN(o))throw new Error(`Invalid roll symbol '${e}'`);if(o<0||o>9)throw new Error(`Invalid roll value '${e}'`);return o}function xe(e){return e==="X"||pe.has(e)}function me(e){return Ke.has(e)}function M(e,o,t){return{symbol:e,value:o,column:t}}function Le(e){const o=[],t={line:e,index:0},a=()=>{for(;t.index<e.length&&we(e[t.index]);)t.index+=1};for(let n=0;n<9;n+=1){if(a(),t.index>=e.length)return{kind:"error",message:`Expected frame ${n+1}, but the line ended early`,column:e.length+1};const s=D(t);if(!s)return{kind:"error",message:`Expected frame ${n+1}, but found nothing`,column:e.length+1};const{char:c,column:i}=s;if(!xe(c))return{kind:"error",message:`Invalid roll '${c}' in frame ${n+1}`,column:i};if(c==="X"){o.push({rolls:[M("X",10,i)],isStrike:!0,isSpare:!1});continue}const m=B(c),f=D(t);if(!f)return{kind:"error",message:`Frame ${n+1} is missing a second roll`,column:e.length+1};const{char:l,column:d}=f;if(l==="X")return{kind:"error",message:`Strike symbol not allowed in second roll of frame ${n+1}`,column:d};if(l==="/"){if(m>=10)return{kind:"error",message:`Spare in frame ${n+1} requires the first roll to be less than 10`,column:d};const $=10-m;o.push({rolls:[M(c,m,i),M("/",$,d)],isStrike:!1,isSpare:!0});continue}if(!pe.has(l))return{kind:"error",message:`Invalid roll '${l}' in frame ${n+1}`,column:d};const p=B(l);if(m+p>10)return{kind:"error",message:`Pins knocked down exceed 10 in frame ${n+1}`,column:d};o.push({rolls:[M(c,m,i),M(l,p,d)],isStrike:!1,isSpare:!1})}if(a(),t.index>=e.length)return{kind:"error",message:"Frame 10 is missing",column:e.length+1};const r=Je(t,e);return r.kind==="error"?r:(o.push(r.frame),a(),t.index<e.length?{kind:"error",message:"Too many rolls provided. Expected exactly 10 frames.",column:t.index+1}:{kind:"success",frames:o})}function Je(e,o){const t=D(e);if(!t)return{kind:"error",message:"Frame 10 is missing",column:o.length+1};const{char:a,column:r}=t;if(!xe(a))return{kind:"error",message:`Invalid roll '${a}' in frame 10`,column:r};if(a==="X")return We(e,r);const n=B(a),s=D(e);if(!s)return{kind:"error",message:"Frame 10 is missing a second roll",column:o.length+1};const{char:c,column:i}=s;if(c==="X")return{kind:"error",message:"Strike symbol not allowed as the second roll unless the first was a strike",column:i};if(c==="/"){if(n>=10)return{kind:"error",message:"Spare in frame 10 requires the first roll to be less than 10",column:i};const f=10-n,l=D(e);if(!l)return{kind:"error",message:"A bonus ball is required after a spare in frame 10",column:o.length+1};const{char:d,column:p}=l;if(d==="/")return{kind:"error",message:"Spare symbol cannot be used for the fill ball after a spare",column:p};if(!me(d))return{kind:"error",message:`Invalid fill ball '${d}' in frame 10`,column:p};const $=d==="X"?10:B(d);return{kind:"success",frame:{rolls:[M(a,n,r),M("/",f,i),M(d,$,p)],isStrike:!1,isSpare:!0}}}if(!pe.has(c))return{kind:"error",message:`Invalid roll '${c}' in frame 10`,column:i};const m=B(c);return n+m>10?{kind:"error",message:"Pins knocked down exceed 10 in frame 10",column:i}:{kind:"success",frame:{rolls:[M(a,n,r),M(c,m,i)],isStrike:!1,isSpare:!1}}}function We(e,o){const t=D(e);if(!t)return{kind:"error",message:"A strike in frame 10 requires two additional rolls",column:o};const{char:a,column:r}=t;if(!me(a)||a==="/")return{kind:"error",message:"Invalid second roll after a strike in frame 10",column:r};let n;a==="X"?n=10:n=B(a);const s=D(e);if(!s)return{kind:"error",message:"A strike in frame 10 requires two additional rolls",column:r};const{char:c,column:i}=s;if(!me(c))return{kind:"error",message:`Invalid fill ball '${c}' in frame 10`,column:i};let m;if(c==="X")m=10;else if(c==="/"){if(a==="X")return{kind:"error",message:"Spare symbol cannot follow a strike in the second roll of frame 10",column:i};if(n>=10)return{kind:"error",message:"Spare symbol invalid because there are no pins remaining",column:i};m=10-n}else if(m=B(c),a!=="X"&&n+m>10)return{kind:"error",message:"Pins knocked down exceed the remaining pins in frame 10",column:i};return{kind:"success",frame:{rolls:[M("X",10,o),M(a,n,r),M(c,m,i)],isStrike:!0,isSpare:!1}}}function Z(e){const o=[],t=[],a=[];for(const s of e){for(const c of s.rolls)o.push(c.value);t.push(s.isStrike),a.push(s.isSpare)}let r=0,n=0;for(let s=0;s<10;s+=1)t[s]?(r+=10+(o[n+1]??0)+(o[n+2]??0),n+=1):a[s]?(r+=10+(o[n+2]??0),n+=2):(r+=(o[n]??0)+(o[n+1]??0),n+=2);return r}function Ze(e){if(e.length!==10)throw new Error("Expected exactly 10 frames");const o=e.slice(0,9),t=e[9],a=[];function r(n,s){if(s===1){a.push([...n,t]);return}for(let c=0;c<s;c++)r(n,s-1),s%2===0?[n[c],n[s-1]]=[n[s-1],n[c]]:[n[0],n[s-1]]=[n[s-1],n[0]]}return r(o,o.length),a}function Qe(e){const o=Ze(e),t=o.map(h=>Z(h)),a=Z(e);t.sort((h,S)=>h-S);const r=t[0],n=t[t.length-1],c=t.reduce((h,S)=>h+S,0)/t.length,i=Math.floor(t.length/2),m=t.length%2===0?(t[i-1]+t[i])/2:t[i],f=new Map;for(const h of t)f.set(h,(f.get(h)||0)+1);let l=0;for(const h of f.values())h>l&&(l=h);const d=[];for(const[h,S]of f)S===l&&d.push(h);d.sort((h,S)=>h-S);const p=[];for(const[h,S]of f)p.push({score:h,count:S,frequency:S/t.length});p.sort((h,S)=>h.score-S.score);const $=t.filter(h=>h<=a).length,w=Math.round($/t.length*100*100)/100,k=t.reduce((h,S)=>h+Math.pow(S-c,2),0)/t.length,x=Math.sqrt(k),F=x===0?0:(a-c)/x,A=t.reduce((h,S)=>h+Math.pow((S-c)/x,3),0),T=x===0?0:A/t.length;return{min:r,max:n,mean:Math.round(c*100)/100,median:m,mode:d,permutationCount:o.length,histogram:p,actualPercentile:w,zScore:Math.round(F*100)/100,skewness:Math.round(T*100)/100,standardDeviation:Math.round(x*100)/100}}function Q(e){const o=[],t=[],a=[];for(const c of e){for(const i of c.rolls)o.push(i.value);t.push(c.isStrike),a.push(c.isSpare)}const r=[];let n=0,s=0;for(let c=0;c<10;c+=1){const i=e[c];let m=0,f=0,l="";t[c]?(m=10+(o[n+1]??0)+(o[n+2]??0),f=10,c===9?l=i.rolls.map(d=>d.symbol).join(" "):l="X",n+=1):a[c]?(m=10+(o[n+2]??0),f=10,l=i.rolls.map(d=>d.symbol).join(""),n+=2):(m=(o[n]??0)+(o[n+1]??0),f=m,l=i.rolls.map(d=>d.symbol).join(""),n+=2),s+=m,r.push({frameNumber:c+1,pinsKnocked:f,scoreContribution:m,cumulativeScore:s,rollSymbols:l,isStrike:i.isStrike,isSpare:i.isSpare})}return r}function et(e){if(e.length!==10)return[];const o=e.slice(0,9),t=e[9],a=Q(e),r=[];for(let n=0;n<9;n++){const s=o[n],c=a[n].scoreContribution,i=[];for(let d=0;d<9;d++){const p=[...o];[p[n],p[d]]=[p[d],p[n]];const $=[...p,t],k=Q($)[d].scoreContribution;i.push(k)}const m=i.reduce((d,p)=>d+p,0)/i.length,f=c-m;let l="";if(s.isStrike)f>5?l=`Lucky placement! Strike got strong bonuses (${Math.round(f)} pins above average for this position)`:f<-5?l=`Unlucky placement! Strike got weak bonuses (${Math.round(Math.abs(f))} pins below average)`:l=`Strike in neutral position (within ${Math.round(Math.abs(f))} pins of average)`;else if(s.isSpare)f>3?l=`Great timing! Spare got a strong bonus ball (${Math.round(f)} pins above average)`:f<-3?l=`Bad timing! Spare got a weak bonus ball (${Math.round(Math.abs(f))} pins below average)`:l=`Spare in neutral position (within ${Math.round(Math.abs(f))} pins of average)`;else{const d=s.rolls.reduce((p,$)=>p+$.value,0);Math.abs(f)<=.5?l=`Open frame (${d} pins) - position doesn't matter much`:l=`Open frame (${d} pins) - minimal positional impact`}r.push({frameNumber:n+1,actualContribution:c,averageContribution:Math.round(m*10)/10,positionBenefit:Math.round(f*10)/10,rollSymbols:a[n].rollSymbols,isStrike:s.isStrike,isSpare:s.isSpare,explanation:l})}return r}const Me="bowling_fortune_saved_games",he="bowling_fortune_draft",Se=1e4;function tt(e,o,t,a){const r=ne(),n={id:it(),scores:e,description:o,league:t,date:a||new Date().toISOString().split("T")[0],savedAt:Date.now(),gameCount:e.trim().split(`
`).filter(s=>s.trim()).length,totalScore:ct(e)};return r.games.unshift(n),r.games.length>Se&&(r.games=r.games.slice(0,Se)),re(r),n}function K(){return ne().games}function ot(e){const o=ne();o.games=o.games.filter(t=>t.id!==e),re(o)}function st(){re({version:1,games:[]})}function nt(){const e=K(),o=new Set;for(const t of e)t.league&&t.league.trim()&&o.add(t.league.trim());return Array.from(o).sort()}function rt(){const e=ne();return JSON.stringify(e,null,2)}function at(e){try{const o=JSON.parse(e);if(!o.version||!Array.isArray(o.games))return{success:!1,count:0,error:"Invalid file format"};for(const t of o.games)if(!t.id||!t.scores||typeof t.savedAt!="number")return{success:!1,count:0,error:"Invalid game data in file"};return re(o),{success:!0,count:o.games.length}}catch{return{success:!1,count:0,error:"Failed to parse JSON file"}}}function ne(){try{const e=localStorage.getItem(Me);return e?JSON.parse(e):{version:1,games:[]}}catch(e){return console.error("Failed to load saved games",e),{version:1,games:[]}}}function re(e){try{localStorage.setItem(Me,JSON.stringify(e))}catch(o){throw o instanceof DOMException&&o.name==="QuotaExceededError"&&alert("Storage quota exceeded. Please delete some saved games."),console.error("Failed to save games",o),o}}function it(){return`${Date.now()}_${Math.random().toString(36).substr(2,4)}`}function ct(e){try{const o=e.trim().split(`
`).filter(a=>a.trim());let t=0;for(const a of o){const r=Le(a);if(r.kind==="error")return;t+=Z(r.frames)}return t}catch{return}}function lt(e){try{e.trim()?localStorage.setItem(he,e):ge()}catch(o){console.error("Failed to save draft",o)}}function dt(){try{return localStorage.getItem(he)}catch(e){return console.error("Failed to load draft",e),null}}function ge(){try{localStorage.removeItem(he)}catch(e){console.error("Failed to clear draft",e)}}function ut(e){const o=[],a=e.split(/<span class="title-headlines">Game \d+<\/span>/).slice(1);if(a.length===0)throw new Error("No games found in LaneTalk HTML");for(const n of a){const s=[],c=n.matchAll(/<div class="frame">.*?<div class="throws">(.*?)<\/div>\s*<div class="score">/gs);for(const m of c){const f=m[1],l=mt(f);s.push(l)}const i=n.match(/<div class="lastFrame">.*?<div class="throws">(.*?)<\/div>\s*<div class="score">/s);if(i){const m=i[1],f=ft(m);s.push(f)}if(s.length!==10)throw new Error(`Expected 10 frames, found ${s.length}`);o.push({frames:s.join(" ")})}const r=pt(e);return{games:o,metadata:r}}function mt(e){const o=e.matchAll(/font-size: 20px[^>]*>\s*([XxX\-0-9]+)\s*<\/span>/g),t=[];for(const r of o)t.push(r[1]);return e.includes('<div class="triangle"></div>')&&t.length===1&&t.push("/"),t.join("")}function ft(e){const o=e.matchAll(/font-size: 20px[^>]*>\s*([XxX\-0-9]+)\s*<\/span>/g),t=[];for(const r of o)t.push(r[1]);const a=(e.match(/<div class="triangle"><\/div>/g)||[]).length;for(let r=0;r<a;r++)t.push("/");return t.join("")}function pt(e){const o={},t=e.match(/<h1>([^<]+)<\/h1>/);t&&(o.bowler=t[1].trim());const a=e.match(/<h2>([^<]*(?:AM|PM)[^<]*)<\/h2>/);a&&(o.date=a[1].trim());const r=e.match(/<h2 class="name">([^<]+)<\/h2>/);r&&(o.location=r[1].trim());const n=e.match(/<span>Total<\/span>\s*<h2>(\d+)<\/h2>/s);n&&(o.total=parseInt(n[1],10));const s=e.match(/<span>Average<\/span>\s*<h2>(\d+)<\/h2>/s);return s&&(o.average=parseInt(s[1],10)),o}function ht(e){try{return new URL(e).hostname==="shared.lanetalk.com"}catch{return!1}}const $e=["Tell My Bowling Fortune","Glimpse Into My Future.. er, Past","Peer Into the Multiverse","Clutch Or Not?","My mom said I'm pretty good.","What oil pattern is this? Badger?","Calculate my shame","How lucky was I, really?","Did I deserve this score?","Explain my misery","Tell me I'm special","Judge my frame order","Was that skill or luck?","Is this thing scratch-and-sniff?","Like a 50/50 raffle, but you never win","We lost by 3 pins, but it definitely wasn't my fault... right?"],ke=["Tell Me How Bad I Fucked Up","RATE MUH BALLS"],gt=.001,Te=[{name:"Perfect Game (300)",description:"The ultimate achievement - 12 strikes in a row",score:"X X X X X X X X X XXX"},{name:"Lucky Game",description:"Actual score much higher than median - very favorable frame order",score:"81 72 63 54 9/ X X X X XXX"},{name:"Unlucky Game",description:"Actual score lower than median - unfavorable frame order",score:"2/ 1/ 35 X 34 62 4/ 45 8/ 60"},{name:"Average Game",description:"Typical performance - score close to median",score:"9/ 45 03 7/ 40 90 09 9/ X 04"},{name:"Low Score Game",description:"Rough day at the lanes - lots of open frames",score:"52 7- 43 8- 61 72 54 6- 81 7-"},{name:"Multiple Games Series",description:"Three-game series showing different performances",score:`9/ X 81 7/ X X 9- 90 X XX6
...
7/ 6- X 81 9/ X 7- X X X90`},{name:"Clutch Performance",description:"Strong finish with strikes in the 10th",score:"7/ 8/ 81 9- 72 X 9/ 8- X XXX"},{name:"All Spares Game",description:"Consistent spare shooting - no strikes, no open frames",score:"9/ 8/ 7/ 6/ 5/ 4/ 3/ 2/ 1/ 9/9"}],Ae=document.querySelector("#app");if(!Ae)throw new Error("Failed to find app container");Ae.innerHTML=`
  ...
  <footer class="version">
    <p>Build: 2025-11-01 01:04:49 CT</p>
  </footer>
...
`),o=[];for(let t=0;t<e.length;t+=1){const a=e[t];if(!a.trim()){fe(`Game ${t+1} is empty. Each line must contain exactly ten frames.`,t+1,1);return}const r=Le(a);if(r.kind==="error"){Mt(r,t,e);return}const n=Z(r.frames),s=Qe(r.frames);o.push({frames:r.frames,score:n,stats:s})}Ue=y.value,Bt(o)}Y.addEventListener("click",se);y.addEventListener("keydown",e=>{e.key==="Enter"&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),se())});document.addEventListener("keydown",e=>{if(e.key==="Escape"){if(J.classList.contains("show")){le();return}if(P.classList.contains("show")){ce();return}if(I){be(),R.focus();return}E.innerHTML&&(E.innerHTML="",y.focus())}});function W(){const o=K().length;Ie.innerHTML=o>0?`&nbsp;(${o})`:"",Ge.innerHTML=o>0?`&nbsp;(${o})`:""}function kt(){if(!y.value.trim()){L("Please enter some scores first");return}const e=new Date().toISOString().split("T")[0];oe.value=e,te.value="",ve.value="";const o=nt();Fe.innerHTML=o.map(t=>`<option value="${t}">`).join(""),P.classList.add("show"),te.focus()}function ce(){P.classList.remove("show")}function wt(){ie.value="",G(),J.classList.add("show"),ae.classList.add("show")}function le(){J.classList.remove("show"),ae.classList.remove("show")}function G(){const e=ie.value.trim().toLowerCase();let o=K();if(e&&(o=o.filter(t=>{const a=(t.description||"").toLowerCase(),r=(t.league||"").toLowerCase();return a.includes(e)||r.includes(e)})),o.length===0){H.innerHTML=e?'<p class="empty-state">No games match your search.</p>':'<p class="empty-state">No saved games yet. Save your first game!</p>';return}H.innerHTML=o.map(t=>{const a=t.gameCount===1?"1 game":`${t.gameCount} games`,r=t.totalScore!==void 0?`🎯 ${t.totalScore}`:"⚠️ Invalid",n=t.description||"(No description)",s=t.league?`🏆 ${t.league}`:"";return`
    ...
    `}).join(""),H.querySelectorAll("[data-load-id]").forEach(t=>{t.addEventListener("click",()=>{const a=t.getAttribute("data-load-id");a&&xt(a)})}),H.querySelectorAll("[data-delete-id]").forEach(t=>{t.addEventListener("click",()=>{const a=t.getAttribute("data-delete-id");a&&Lt(a)})})}function xt(e){const t=K().find(a=>a.id===e);t&&(y.value=t.scores,le(),Y.click(),L("Game loaded!"))}function Lt(e){confirm("Delete this saved game?")&&(ot(e),W(),G(),L("Game deleted"))}Xe.addEventListener("click",kt);Ce.addEventListener("click",wt);De.addEventListener("click",ce);Be.addEventListener("click",le);ae.addEventListener("click",le);ie.addEventListener("input",()=>{G()});P.addEventListener("click",e=>{e.target===P&&ce()});qe.addEventListener("submit",e=>{e.preventDefault();const o=y.value.trim(),t=te.value.trim()||void 0,a=ve.value.trim()||void 0;let r=oe.value||void 0;if(r){const n=new Date(r),s=new Date;if(s.setHours(0,0,0,0),n>s){L("Date cannot be in the future"),oe.focus();return}}try{tt(o,t,a,r),ce(),ge(),W(),J.classList.contains("show")&&G(),L("Game saved!")}catch(n){console.error("Failed to save game",n),L("Failed to save game")}});Re.addEventListener("click",()=>{confirm("Delete ALL saved games? This cannot be undone.")&&(st(),W(),G(),L("All games deleted"))});Ne.addEventListener("click",()=>{const e=K();if(e.length===0){L("No games to export");return}const o=rt(),t=new Blob([o],{type:"application/json"}),a=URL.createObjectURL(t),r=document.createElement("a");r.href=a,r.download=`bowling-games-${new Date().toISOString().split("T")[0]}.json`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(a),L(`Exported ${e.length} game${e.length===1?"":"s"}`)});Pe.addEventListener("click",()=>{U.click()});U.addEventListener("change",e=>{const o=e.target.files?.[0];if(!o)return;const t=new FileReader;t.onload=a=>{const r=a.target?.result,n=at(r);n.success?(W(),G(),L(`Imported ${n.count} game${n.count===1?"":"s"}`)):L(n.error||"Import failed"),U.value=""},t.onerror=()=>{L("Failed to read file"),U.value=""},t.readAsText(o)});W();window.addEventListener("DOMContentLoaded",()=>{const o=new URLSearchParams(window.location.search).get("scores");if(o)try{const t=atob(o);y.value=t,se()}catch(t){console.error("Failed to decode scores from URL",t)}else{const t=dt();t&&(y.value=t,se())}});function Mt(e,o,t){const a=o+1,r=`Row ${a}, column ${e.column}: ${e.message}`,n=Ye(t,o,e.column);fe(r,a,e.column,n)}function Ye(e,o,t){let a=0;for(let r=0;r<o;r+=1)a+=e[r].length+1;return a+(t-1)}function fe(e,o,t,a){if(E.innerHTML="",E.className="error",E.textContent=e,y.focus(),typeof a=="number")y.setSelectionRange(a,a);else{const r=y.value.replace(/\r/g,"").split(`
`),n=Ye(r,o-1,t);y.setSelectionRange(n,n)}}function Tt(e){const{histogram:o,median:t}=e.stats,a=e.score,r=600,n=300,s={top:20,right:20,bottom:40,left:50},c=r-s.left-s.right,i=n-s.top-s.bottom,m=e.stats.min,f=e.stats.max,l=new Map(o.map(b=>[b.score,b])),d=[];for(let b=m;b<=f;b++){const v=l.get(b);d.push({score:b,count:v?.count??0,frequency:v?.frequency??0})}const p=Math.max(...d.map(b=>b.count)),$=Math.max(2,c/d.length),w=d.map((b,v)=>{const u=s.left+v*c/d.length,g=b.count/p*i,O=s.top+i-g,X=b.score===a;return`<rect
      x="${u}"
      y="${O}"
      width="${$}"
      height="${g}"
...
Frequency: ${(b.frequency*100).toFixed(2)}%</title>
    </rect>`}).join(""),k=t-m,x=s.left+k*c/d.length+$/2,F=`
  ...
  `}function At(e,o,t){return e>=95?"🏆":t===o?"🎯":e<=5?"💀":e>=75?"🍀":e<=25?"😅":"📊"}function Et(e){const{zScore:o,actualPercentile:t,skewness:a,median:r}=e.stats;e.score-e.stats.median;let s=`${At(t,r,e.score)} `;return Math.abs(o)<.5?s+="Your score was <strong>typical</strong> — right in line with what frame order randomness would produce.":o>=2?s+="Your score was <strong>exceptionally high</strong> — you got very lucky with your frame order!":o<=-2?s+="Your score was <strong>exceptionally low</strong> — you got very unlucky with your frame order.":o>1?s+="Your score was <strong>notably above average</strong> — you benefited from a favorable frame sequence.":o<-1?s+="Your score was <strong>notably below average</strong> — your frame order worked against you.":o>0?s+="Your score was <strong>slightly above average</strong> — a bit luckier than typical.":s+="Your score was <strong>slightly below average</strong> — a bit unluckier than typical.",t>=95?s+=" You scored in the <strong>top 5%</strong> of all possible orderings.":t>=75?s+=" You scored in the <strong>top quartile</strong> of possible orderings.":t<=5?s+=" You scored in the <strong>bottom 5%</strong> of all possible orderings.":t<=25&&(s+=" You scored in the <strong>bottom quartile</strong> of possible orderings."),s}function _e(e){let o=new Map;for(const t of e[0].stats.histogram)o.set(t.score,t.count);for(let t=1;t<e.length;t++){const a=new Map;for(const[r,n]of o)for(const s of e[t].stats.histogram){const c=r+s.score,i=n*s.count;a.set(c,(a.get(c)||0)+i)}o=a}return o}function Xt(e,o){const t=_e(e),a=[];for(const[u,g]of t)a.push({score:u,count:g});a.sort((u,g)=>u.score-g.score);const r=600,n=300,s={top:20,right:20,bottom:40,left:50},c=r-s.left-s.right,i=n-s.top-s.bottom,m=a[0].score,f=a[a.length-1].score,l=new Map(a.map(u=>[u.score,u])),d=[];for(let u=m;u<=f;u++){const g=l.get(u);d.push({score:u,count:g?.count??0})}const p=Math.max(...d.map(u=>u.count)),$=Array.from(t.values()).reduce((u,g)=>u+g,0);let w=0,k=0;for(const u of a)if(w+=u.count,w>=$/2){k=u.score;break}const x=Math.max(2,c/d.length),F=d.map((u,g)=>{const O=s.left+g*c/d.length,X=u.count/p*i,ze=s.top+i-X,ye=u.score===o;return`<rect
      x="${O}"
      y="${ze}"
      width="${x}"
      height="${X}"
...
Combinations: ${u.count.toLocaleString()}</title>
  ...
  `}function It(){const e=btoa(Ue),o=new URL(window.location.href);return o.search=`?scores=${encodeURIComponent(e)}`,o.toString()}function qt(){const e=It();navigator.clipboard.writeText(e).then(()=>{L("Link copied!")}).catch(o=>{console.error("Failed to copy link",o),L("Failed to copy link")})}function L(e){const o=document.querySelector(".toast");o&&o.remove();const t=document.createElement("div");t.className="toast",t.textContent=e,document.body.appendChild(t),setTimeout(()=>{t.classList.add("show")},10),setTimeout(()=>{t.classList.remove("show"),setTimeout(()=>{t.remove()},300)},2e3)}function Ft(e){return`
  ...
  `}function Dt(e){const o=Q(e),t=et(e),a=3,r=-3,n=t.filter(l=>l.positionBenefit>=a).sort((l,d)=>d.positionBenefit-l.positionBenefit),s=t.filter(l=>l.positionBenefit<=r).sort((l,d)=>l.positionBenefit-d.positionBenefit);function c(){return`
      <div class="complete-scorecard">
        <div class="scorecard-row">
  ...
  `}function Bt(e){if(E.className="output",e.length===0){E.innerHTML="";return}const o=`
    <button type="button" class="copy-link-btn" data-copy-link>
      Copy link 🔗
    </button>
  `,t=e.map((n,s)=>{const c=s+1,i=n.stats.mode.length===1?n.stats.mode[0].toString():`${n.stats.mode.join(", ")} (multimodal)`,m=n.score-n.stats.median,f=m>=0?`+${m}`:`${m}`,l=Et(n);return`
