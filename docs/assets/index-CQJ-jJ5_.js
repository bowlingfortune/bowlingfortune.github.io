(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();const Je=new Set([" ","	",",",";"]),fe=new Set("0123456789-".split("")),We=new Set("0123456789-X/".split(""));function ke(e){return Je.has(e)}function F(e){const{line:o}=e;for(;e.index<o.length&&ke(o[e.index]);)e.index+=1;if(e.index>=o.length)return null;const t=e.index+1,a=o[e.index].toUpperCase();return e.index+=1,{char:a,column:t}}function D(e){if(e==="X")return 10;if(e==="-")return 0;const o=Number.parseInt(e,10);if(Number.isNaN(o))throw new Error(`Invalid roll symbol '${e}'`);if(o<0||o>9)throw new Error(`Invalid roll value '${e}'`);return o}function xe(e){return e==="X"||fe.has(e)}function ue(e){return We.has(e)}function M(e,o,t){return{symbol:e,value:o,column:t}}function Le(e){const o=[],t={line:e,index:0},a=()=>{for(;t.index<e.length&&ke(e[t.index]);)t.index+=1};for(let s=0;s<9;s+=1){if(a(),t.index>=e.length)return{kind:"error",message:`Expected frame ${s+1}, but the line ended early`,column:e.length+1};const n=F(t);if(!n)return{kind:"error",message:`Expected frame ${s+1}, but found nothing`,column:e.length+1};const{char:i,column:c}=n;if(!xe(i))return{kind:"error",message:`Invalid roll '${i}' in frame ${s+1}`,column:c};if(i==="X"){o.push({rolls:[M("X",10,c)],isStrike:!0,isSpare:!1});continue}const m=D(i),f=F(t);if(!f)return{kind:"error",message:`Frame ${s+1} is missing a second roll`,column:e.length+1};const{char:l,column:d}=f;if(l==="X")return{kind:"error",message:`Strike symbol not allowed in second roll of frame ${s+1}`,column:d};if(l==="/"){if(m>=10)return{kind:"error",message:`Spare in frame ${s+1} requires the first roll to be less than 10`,column:d};const $=10-m;o.push({rolls:[M(i,m,c),M("/",$,d)],isStrike:!1,isSpare:!0});continue}if(!fe.has(l))return{kind:"error",message:`Invalid roll '${l}' in frame ${s+1}`,column:d};const p=D(l);if(m+p>10)return{kind:"error",message:`Pins knocked down exceed 10 in frame ${s+1}`,column:d};o.push({rolls:[M(i,m,c),M(l,p,d)],isStrike:!1,isSpare:!1})}if(a(),t.index>=e.length)return{kind:"error",message:"Frame 10 is missing",column:e.length+1};const r=Ze(t,e);return r.kind==="error"?r:(o.push(r.frame),a(),t.index<e.length?{kind:"error",message:"Too many rolls provided. Expected exactly 10 frames.",column:t.index+1}:{kind:"success",frames:o})}function Ze(e,o){const t=F(e);if(!t)return{kind:"error",message:"Frame 10 is missing",column:o.length+1};const{char:a,column:r}=t;if(!xe(a))return{kind:"error",message:`Invalid roll '${a}' in frame 10`,column:r};if(a==="X")return Qe(e,r);const s=D(a),n=F(e);if(!n)return{kind:"error",message:"Frame 10 is missing a second roll",column:o.length+1};const{char:i,column:c}=n;if(i==="X")return{kind:"error",message:"Strike symbol not allowed as the second roll unless the first was a strike",column:c};if(i==="/"){if(s>=10)return{kind:"error",message:"Spare in frame 10 requires the first roll to be less than 10",column:c};const f=10-s,l=F(e);if(!l)return{kind:"error",message:"A bonus ball is required after a spare in frame 10",column:o.length+1};const{char:d,column:p}=l;if(d==="/")return{kind:"error",message:"Spare symbol cannot be used for the fill ball after a spare",column:p};if(!ue(d))return{kind:"error",message:`Invalid fill ball '${d}' in frame 10`,column:p};const $=d==="X"?10:D(d);return{kind:"success",frame:{rolls:[M(a,s,r),M("/",f,c),M(d,$,p)],isStrike:!1,isSpare:!0}}}if(!fe.has(i))return{kind:"error",message:`Invalid roll '${i}' in frame 10`,column:c};const m=D(i);return s+m>10?{kind:"error",message:"Pins knocked down exceed 10 in frame 10",column:c}:{kind:"success",frame:{rolls:[M(a,s,r),M(i,m,c)],isStrike:!1,isSpare:!1}}}function Qe(e,o){const t=F(e);if(!t)return{kind:"error",message:"A strike in frame 10 requires two additional rolls",column:o};const{char:a,column:r}=t;if(!ue(a)||a==="/")return{kind:"error",message:"Invalid second roll after a strike in frame 10",column:r};let s;a==="X"?s=10:s=D(a);const n=F(e);if(!n)return{kind:"error",message:"A strike in frame 10 requires two additional rolls",column:r};const{char:i,column:c}=n;if(!ue(i))return{kind:"error",message:`Invalid fill ball '${i}' in frame 10`,column:c};let m;if(i==="X")m=10;else if(i==="/"){if(a==="X")return{kind:"error",message:"Spare symbol cannot follow a strike in the second roll of frame 10",column:c};if(s>=10)return{kind:"error",message:"Spare symbol invalid because there are no pins remaining",column:c};m=10-s}else if(m=D(i),a!=="X"&&s+m>10)return{kind:"error",message:"Pins knocked down exceed the remaining pins in frame 10",column:c};return{kind:"success",frame:{rolls:[M("X",10,o),M(a,s,r),M(i,m,c)],isStrike:!0,isSpare:!1}}}function K(e){const o=[],t=[],a=[];for(const n of e){for(const i of n.rolls)o.push(i.value);t.push(n.isStrike),a.push(n.isSpare)}let r=0,s=0;for(let n=0;n<10;n+=1)t[n]?(r+=10+(o[s+1]??0)+(o[s+2]??0),s+=1):a[n]?(r+=10+(o[s+2]??0),s+=2):(r+=(o[s]??0)+(o[s+1]??0),s+=2);return r}function et(e){if(e.length!==10)throw new Error("Expected exactly 10 frames");const o=e.slice(0,9),t=e[9],a=[];function r(s,n){if(n===1){a.push([...s,t]);return}for(let i=0;i<n;i++)r(s,n-1),n%2===0?[s[i],s[n-1]]=[s[n-1],s[i]]:[s[0],s[n-1]]=[s[n-1],s[0]]}return r(o,o.length),a}function tt(e){const o=et(e),t=o.map(h=>K(h)),a=K(e);t.sort((h,y)=>h-y);const r=t[0],s=t[t.length-1],i=t.reduce((h,y)=>h+y,0)/t.length,c=Math.floor(t.length/2),m=t.length%2===0?(t[c-1]+t[c])/2:t[c],f=new Map;for(const h of t)f.set(h,(f.get(h)||0)+1);let l=0;for(const h of f.values())h>l&&(l=h);const d=[];for(const[h,y]of f)y===l&&d.push(h);d.sort((h,y)=>h-y);const p=[];for(const[h,y]of f)p.push({score:h,count:y,frequency:y/t.length});p.sort((h,y)=>h.score-y.score);const $=t.filter(h=>h<=a).length,k=Math.round($/t.length*100*100)/100,w=t.reduce((h,y)=>h+Math.pow(y-i,2),0)/t.length,x=Math.sqrt(w),q=x===0?0:(a-i)/x,E=t.reduce((h,y)=>h+Math.pow((y-i)/x,3),0),T=x===0?0:E/t.length;return{min:r,max:s,mean:Math.round(i*100)/100,median:m,mode:d,permutationCount:o.length,histogram:p,actualPercentile:k,zScore:Math.round(q*100)/100,skewness:Math.round(T*100)/100,standardDeviation:Math.round(x*100)/100}}function J(e){const o=[],t=[],a=[];for(const i of e){for(const c of i.rolls)o.push(c.value);t.push(i.isStrike),a.push(i.isSpare)}const r=[];let s=0,n=0;for(let i=0;i<10;i+=1){const c=e[i];let m=0,f=0,l="";t[i]?(m=10+(o[s+1]??0)+(o[s+2]??0),f=10,i===9?l=c.rolls.map(d=>d.symbol).join(" "):l="X",s+=1):a[i]?(m=10+(o[s+2]??0),f=10,l=c.rolls.map(d=>d.symbol).join(""),s+=2):(m=(o[s]??0)+(o[s+1]??0),f=m,l=c.rolls.map(d=>d.symbol).join(""),s+=2),n+=m,r.push({frameNumber:i+1,pinsKnocked:f,scoreContribution:m,cumulativeScore:n,rollSymbols:l,isStrike:c.isStrike,isSpare:c.isSpare})}return r}function ot(e){if(e.length!==10)return[];const o=e.slice(0,9),t=e[9],a=J(e),r=[];for(let s=0;s<9;s++){const n=o[s],i=a[s].scoreContribution,c=[];for(let d=0;d<9;d++){const p=[...o];[p[s],p[d]]=[p[d],p[s]];const $=[...p,t],w=J($)[d].scoreContribution;c.push(w)}const m=c.reduce((d,p)=>d+p,0)/c.length,f=i-m;let l="";if(n.isStrike)f>5?l=`Lucky placement! Strike got strong bonuses (${Math.round(f)} pins above average for this position)`:f<-5?l=`Unlucky placement! Strike got weak bonuses (${Math.round(Math.abs(f))} pins below average)`:l=`Strike in neutral position (within ${Math.round(Math.abs(f))} pins of average)`;else if(n.isSpare)f>3?l=`Great timing! Spare got a strong bonus ball (${Math.round(f)} pins above average)`:f<-3?l=`Bad timing! Spare got a weak bonus ball (${Math.round(Math.abs(f))} pins below average)`:l=`Spare in neutral position (within ${Math.round(Math.abs(f))} pins of average)`;else{const d=n.rolls.reduce((p,$)=>p+$.value,0);Math.abs(f)<=.5?l=`Open frame (${d} pins) - position doesn't matter much`:l=`Open frame (${d} pins) - minimal positional impact`}r.push({frameNumber:s+1,actualContribution:i,averageContribution:Math.round(m*10)/10,positionBenefit:Math.round(f*10)/10,rollSymbols:a[s].rollSymbols,isStrike:n.isStrike,isSpare:n.isSpare,explanation:l})}return r}const Me="bowling_fortune_saved_games",pe="bowling_fortune_draft",Se=1e4;function st(e,o,t,a){const r=oe(),s={id:lt(),scores:e,description:o,league:t,date:a||new Date().toISOString().split("T")[0],savedAt:Date.now(),gameCount:e.trim().split(`
...
`).filter(a=>a.trim());let t=0;for(const a of o){const r=Le(a);if(r.kind==="error")return;t+=K(r.frames)}return t}catch{return}}function ut(e){try{e.trim()?localStorage.setItem(pe,e):he()}catch(o){console.error("Failed to save draft",o)}}function mt(){try{return localStorage.getItem(pe)}catch(e){return console.error("Failed to load draft",e),null}}function he(){try{localStorage.removeItem(pe)}catch(e){console.error("Failed to clear draft",e)}}function ft(e){const o=[],a=e.split(/<span class="title-headlines">Game \d+<\/span>/).slice(1);if(a.length===0)throw new Error("No games found in LaneTalk HTML");for(const s of a){const n=[],i=s.matchAll(/<div class="frame">.*?<div class="throws">(.*?)<\/div>\s*<div class="score">/gs);for(const m of i){const f=m[1],l=pt(f);n.push(l)}const c=s.match(/<div class="lastFrame">.*?<div class="throws">(.*?)<\/div>\s*<div class="score">/s);if(c){const m=c[1],f=ht(m);n.push(f)}if(n.length!==10)throw new Error(`Expected 10 frames, found ${n.length}`);o.push({frames:n.join(" ")})}const r=gt(e);return{games:o,metadata:r}}function pt(e){const o=e.matchAll(/font-size: 20px[^>]*>\s*([XxX\-0-9]+)\s*<\/span>/g),t=[];for(const r of o)t.push(r[1]);return e.includes('<div class="triangle"></div>')&&t.length===1&&t.push("/"),t.join("")}function ht(e){const o=e.matchAll(/font-size: 20px[^>]*>\s*([XxX\-0-9]+)\s*<\/span>/g),t=[];for(const r of o)t.push(r[1]);const a=(e.match(/<div class="triangle"><\/div>/g)||[]).length;for(let r=0;r<a;r++)t.push("/");return t.join("")}function gt(e){const o={},t=e.match(/<h1>([^<]+)<\/h1>/);t&&(o.bowler=t[1].trim());const a=e.match(/<h2>([^<]*(?:AM|PM)[^<]*)<\/h2>/);a&&(o.date=a[1].trim());const r=e.match(/<h2 class="name">([^<]+)<\/h2>/);r&&(o.location=r[1].trim());const s=e.match(/<span>Total<\/span>\s*<h2>(\d+)<\/h2>/s);s&&(o.total=parseInt(s[1],10));const n=e.match(/<span>Average<\/span>\s*<h2>(\d+)<\/h2>/s);return n&&(o.average=parseInt(n[1],10)),o}function vt(e){try{return new URL(e).hostname==="shared.lanetalk.com"}catch{return!1}}const $e=["Tell My Bowling Fortune","Glimpse Into My Future.. er, Past","Peer Into the Multiverse","Clutch Or Not?","My mom said I'm pretty good.","What oil pattern is this? Badger?","Calculate my shame","How lucky was I, really?","Did I deserve this score?","Explain my misery","Tell me I'm special","Judge my frame order","Was that skill or luck?","Is this thing scratch-and-sniff?","Like a 50/50 raffle, but you never win","We lost by 3 pins, but it definitely wasn't my fault... right?"],we=["Tell Me How Bad I Fucked Up","RATE MUH BALLS"],bt=.001,Te=[{name:"Perfect Game (300)",description:"The ultimate achievement - 12 strikes in a row",score:"X X X X X X X X X XXX"},{name:"Lucky Game",description:"Actual score much higher than median - very favorable frame order",score:"81 72 63 54 9/ X X X X XXX"},{name:"Unlucky Game",description:"Actual score lower than median - unfavorable frame order",score:"2/ 1/ 35 X 34 62 4/ 45 8/ 60"},{name:"Average Game",description:"Typical performance - score close to median",score:"9/ 45 03 7/ 40 90 09 9/ X 04"},{name:"Low Score Game",description:"Rough day at the lanes - lots of open frames",score:"52 7- 43 8- 61 72 54 6- 81 7-"},{name:"Multiple Games Series",description:"Three-game series showing different performances",score:`9/ X 81 7/ X X 9- 90 X XX6
...
7/ 6- X 81 9/ X 7- X X X90`},{name:"Clutch Performance",description:"Strong finish with strikes in the 10th",score:"7/ 8/ 81 9- 72 X 9/ 8- X XXX"},{name:"All Spares Game",description:"Consistent spare shooting - no strikes, no open frames",score:"9/ 8/ 7/ 6/ 5/ 4/ 3/ 2/ 1/ 9/9"}],Ee=document.querySelector("#app");if(!Ee)throw new Error("Failed to find app container");Ee.innerHTML=`
  ...
  <footer class="version">
    <p>Build: 2025-11-06 16:37:54 CT</p>
  </footer>
...
`),o=[];for(let t=0;t<e.length;t+=1){const a=e[t];if(!a.trim()){me(`Game ${t+1} is empty. Each line must contain exactly ten frames.`,t+1,1);return}const r=Le(a);if(r.kind==="error"){Tt(r,t,e);return}const s=K(r.frames),n=tt(r.frames);o.push({frames:r.frames,score:s,stats:n})}ze=S.value,Nt(o)}U.addEventListener("click",te);S.addEventListener("keydown",e=>{e.key==="Enter"&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),te())});document.addEventListener("keydown",e=>{if(e.key==="Escape"){if(B.classList.contains("show")){be();return}if(_.classList.contains("show")){ce();return}if(N.classList.contains("show")){ie();return}if(X){ve(),P.focus();return}C.innerHTML&&(C.innerHTML="",S.focus())}});function V(){const o=z().length;Fe.innerHTML=o>0?`&nbsp;(${o})`:"",He.innerHTML=o>0?`&nbsp;(${o})`:""}function kt(){if(!S.value.trim()){L("Please enter some scores first");return}const e=new Date().toISOString().split("T")[0];ee.value=e,Q.value="",ge.value="";const o=at();Be.innerHTML=o.map(t=>`<option value="${t}">`).join(""),N.classList.add("show"),Q.focus()}function ie(){N.classList.remove("show")}function xt(){ae.value="",G(),_.classList.add("show"),re.classList.add("show")}function ce(){_.classList.remove("show"),re.classList.remove("show")}function G(){const e=ae.value.trim().toLowerCase();let o=z();if(e&&(o=o.filter(t=>{const a=(t.description||"").toLowerCase(),r=(t.league||"").toLowerCase();return a.includes(e)||r.includes(e)})),o.length===0){H.innerHTML=e?'<p class="empty-state">No games match your search.</p>':'<p class="empty-state">No saved games yet. Save your first game!</p>';return}H.innerHTML=o.map(t=>{const a=t.gameCount===1?"1 game":`${t.gameCount} games`,r=t.totalScore!==void 0?`🎯 ${t.totalScore}`:"⚠️ Invalid",s=t.description||"(No description)",n=t.league?`🏆 ${t.league}`:"";return`
    ...
    `}).join(""),H.querySelectorAll("[data-load-id]").forEach(t=>{t.addEventListener("click",()=>{const a=t.getAttribute("data-load-id");a&&Lt(a)})}),H.querySelectorAll("[data-delete-id]").forEach(t=>{t.addEventListener("click",()=>{const a=t.getAttribute("data-delete-id");a&&Mt(a)})})}function Lt(e){const t=z().find(a=>a.id===e);t&&(S.value=t.scores,ce(),U.click(),L("Game loaded!"))}function Mt(e){confirm("Delete this saved game?")&&(nt(e),V(),G(),L("Game deleted"))}Ie.addEventListener("click",kt);qe.addEventListener("click",xt);Ne.addEventListener("click",ie);Pe.addEventListener("click",ce);re.addEventListener("click",ce);ae.addEventListener("input",()=>{G()});N.addEventListener("click",e=>{e.target===N&&ie()});De.addEventListener("submit",e=>{e.preventDefault();const o=S.value.trim(),t=Q.value.trim()||void 0,a=ge.value.trim()||void 0;let r=ee.value||void 0;if(r){const s=new Date(r),n=new Date;if(n.setHours(0,0,0,0),s>n){L("Date cannot be in the future"),ee.focus();return}}try{st(o,t,a,r),ie(),he(),V(),_.classList.contains("show")&&G(),L("Game saved!")}catch(s){console.error("Failed to save game",s),L("Failed to save game")}});Re.addEventListener("click",()=>{confirm("Delete ALL saved games? This cannot be undone.")&&(rt(),V(),G(),L("All games deleted"))});Ge.addEventListener("click",()=>{const e=z();if(e.length===0){L("No games to export");return}const o=it(),t=new Blob([o],{type:"application/json"}),a=URL.createObjectURL(t),r=document.createElement("a");r.href=a,r.download=`bowling-games-${new Date().toISOString().split("T")[0]}.json`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(a),L(`Exported ${e.length} game${e.length===1?"":"s"}`)});Oe.addEventListener("click",()=>{j.click()});j.addEventListener("change",e=>{const o=e.target.files?.[0];if(!o)return;const t=new FileReader;t.onload=a=>{const r=a.target?.result,s=ct(r);s.success?(V(),G(),L(`Imported ${s.count} game${s.count===1?"":"s"}`)):L(s.error||"Import failed"),j.value=""},t.onerror=()=>{L("Failed to read file"),j.value=""},t.readAsText(o)});V();window.addEventListener("DOMContentLoaded",()=>{const o=new URLSearchParams(window.location.search).get("scores");if(o)try{const t=atob(o);S.value=t,te()}catch(t){console.error("Failed to decode scores from URL",t)}else{const t=mt();t&&(S.value=t,te())}});function Tt(e,o,t){const a=o+1,r=`Row ${a}, column ${e.column}: ${e.message}`,s=_e(t,o,e.column);me(r,a,e.column,s)}function _e(e,o,t){let a=0;for(let r=0;r<o;r+=1)a+=e[r].length+1;return a+(t-1)}function me(e,o,t,a){if(C.innerHTML="",C.className="error",C.textContent=e,S.focus(),typeof a=="number")S.setSelectionRange(a,a);else{const r=S.value.replace(/\r/g,"").split(`
`),s=_e(r,o-1,t);S.setSelectionRange(s,s)}}function Et(e){const{histogram:o,median:t}=e.stats,a=e.score,r=600,s=300,n={top:20,right:20,bottom:40,left:50},i=r-n.left-n.right,c=s-n.top-n.bottom,m=e.stats.min,f=e.stats.max,l=new Map(o.map(b=>[b.score,b])),d=[];for(let b=m;b<=f;b++){const v=l.get(b);d.push({score:b,count:v?.count??0,frequency:v?.frequency??0})}const p=Math.max(...d.map(b=>b.count)),$=Math.max(2,i/d.length),k=d.map((b,v)=>{const u=n.left+v*i/d.length,g=b.count/p*c,O=n.top+c-g,A=b.score===a;return`<rect
      x="${u}"
      y="${O}"
      width="${$}"
      height="${g}"
...
Frequency: ${(b.frequency*100).toFixed(2)}%</title>
    </rect>`}).join(""),w=t-m,x=n.left+w*i/d.length+$/2,q=`
  ...
  `}function Ct(e,o,t){return e>=95?"🏆":t===o?"🎯":e<=5?"💀":e>=75?"🍀":e<=25?"😅":"📊"}function At(e){const{zScore:o,actualPercentile:t,skewness:a,median:r}=e.stats,s=e.score-e.stats.median;let i=`${Ct(t,r,e.score)} `;Math.abs(o)<.5?i+="Your score was <strong>typical</strong> — right in line with what frame order randomness would produce.":o>=2?i+="Your score was <strong>exceptionally high</strong> — you got very lucky with your frame order!":o<=-2?i+="Your score was <strong>exceptionally low</strong> — you got very unlucky with your frame order.":o>1?i+="Your score was <strong>notably above average</strong> — you benefited from a favorable frame sequence.":o<-1?i+="Your score was <strong>notably below average</strong> — your frame order worked against you.":o>0?i+="Your score was <strong>slightly above average</strong> — a bit luckier than typical.":i+="Your score was <strong>slightly below average</strong> — a bit unluckier than typical.",t>=95?i+=" You scored in the <strong>top 5%</strong> of all possible orderings.":t>=75?i+=" You scored in the <strong>top quartile</strong> of possible orderings.":t<=5?i+=" You scored in the <strong>bottom 5%</strong> of all possible orderings.":t<=25&&(i+=" You scored in the <strong>bottom quartile</strong> of possible orderings.");const c=s>=0?`+${s}`:`${s}`;return i+=` Your actual score was <strong>${c} pins</strong> from the median.`,i}function Ve(e){let o=new Map;for(const t of e[0].stats.histogram)o.set(t.score,t.count);for(let t=1;t<e.length;t++){const a=new Map;for(const[r,s]of o)for(const n of e[t].stats.histogram){const i=r+n.score,c=s*n.count;a.set(i,(a.get(i)||0)+c)}o=a}return o}function Xt(e,o){const t=Ve(e),a=[];for(const[u,g]of t)a.push({score:u,count:g});a.sort((u,g)=>u.score-g.score);const r=600,s=300,n={top:20,right:20,bottom:40,left:50},i=r-n.left-n.right,c=s-n.top-n.bottom,m=a[0].score,f=a[a.length-1].score,l=new Map(a.map(u=>[u.score,u])),d=[];for(let u=m;u<=f;u++){const g=l.get(u);d.push({score:u,count:g?.count??0})}const p=Math.max(...d.map(u=>u.count)),$=Array.from(t.values()).reduce((u,g)=>u+g,0);let k=0,w=0;for(const u of a)if(k+=u.count,k>=$/2){w=u.score;break}const x=Math.max(2,i/d.length),q=d.map((u,g)=>{const O=n.left+g*i/d.length,A=u.count/p*c,Ke=n.top+c-A,ye=u.score===o;return`<rect
      x="${O}"
      y="${Ke}"
      width="${x}"
      height="${A}"
...
Combinations: ${u.count.toLocaleString()}</title>
  ...
  `}function Bt(e){const o=J(e),t=ot(e),a=3,r=-3,s=t.filter(l=>l.positionBenefit>=a).sort((l,d)=>d.positionBenefit-l.positionBenefit),n=t.filter(l=>l.positionBenefit<=r).sort((l,d)=>l.positionBenefit-d.positionBenefit);function i(){return`
      <div class="complete-scorecard">
        <div class="scorecard-row">
  ...
  `,t=e.map((s,n)=>{const i=n+1,c=s.stats.mode.length===1?s.stats.mode[0].toString():`${s.stats.mode.join(", ")} (multimodal)`,m=s.score-s.stats.median,f=m>=0?`+${m}`:`${m}`,l=At(s);return`
